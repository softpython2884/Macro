...
const CORE_APPS: AppInfo[] = [
  ...
  { id: 'store', name: 'App Store', icon: Download, href: '/dashboard/store', description: 'Find new apps & games', posterUrl: 'https://cdn2.steamgriddb.com/thumb/548ac132d1da8285bfd71130da4ee0fa.jpg' },
